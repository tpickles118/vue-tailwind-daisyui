      ...
      <div class="text-base-content pt-6 transition-colors duration-500 bg-base-200">
        ...
        <RowBufferedSlotted>
          ...
          <TabsContainerSmSlotted>
            ...
            <LabeledInputSlotted :button-model="buttonKeyValueList" @button-clicked="callback">
          ...
          <div class="text-base-content mx-auto grid gap-6 pb-20 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 [&amp;_.carbon-responsive-wrap]:flex-nowrap! [&amp;_.carbon-responsive-wrap]:text-[11px]! [&amp;_:is(div,button)]:[transition:background-color_0ms,border-color_100ms,box-shadow_300ms,border-radius_500ms_ease-out] [&amp;>*]:mb-6">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="card-body gap-4">
                  <div class="border-b-base-300 grid grid-cols-7 border-b border-dashed pb-3">
                    ...
                    <div class="rounded-field bg-primary text-primary-content flex flex-col items-center px-2 py-1">
                      ...
                      <span
                          class="text-[10px] font-semibold opacity-50">W</span>
                    </div>
                    <div class="rounded-field flex flex-col items-center px-2 py-1">
                  ...
                  <div class="flex flex-col gap-2">
                    <label class="flex cursor-pointer items-center gap-2">
                      <input
                          ...
                          type="checkbox">
                      <span
                          class="text-xs">Show all day events</span>
                    </label>
                  </div>
                </div>
              </CardSlotted>
              ...
              <div>
                <div class="tabs tabs-lift"
                     role="tablist">
                  <input aria-label="Tab 1"
                         class="tab"
                         name="my_tabs_2"
                         role="tab"
                         type="radio">
                  <div class="tab-content bg-base-100 border-base-300 p-6">Tab content 1</div>
                  <input aria-label="Tab 2"
                         checked="checked"
                         class="tab"
                         name="my_tabs_2"
                         role="tab"
              ...
              <div class="card bg-base-100 card-border border-base-300 card-sm">
                <div class="card-body gap-4">
                  <h2 class="flex items-center justify-between"><span class="flex items-center gap-2 font-semibold"><svg
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"></path></svg> Price range</span>
                  </h2>
                  <div class="text-center text-5xl font-extralight">80</div>
                  <input class="range range-sm"
                         type="range">
                </div>
              </div>
              <div class="card bg-base-100 card-border border-base-300 card-sm">
                ...
                <div class="card-body gap-4">
                  <h2 class="flex items-center justify-between"><span
                      class="font-semibold">Nike Shoes</span>
                ...
                <div class="card-body gap-4">
                  <div class="join">
                    <label class="join-item input-border input flex w-auto items-center gap-2">
                      <svg class="h-4 w-4 shrink-0 opacity-70"
                           fill="currentColor"
                           viewBox="0 0 16 16"
                           xmlns="http://www.w3.org/2000/svg">
                        <path clip-rule="evenodd"
              ...
              <div class="card bg-base-100 card-border border-base-300 card-sm overflow-hidden">
                ...
                <div class="card-body gap-4">
                  <p class="text-xs opacity-60">Registration is free and only takes a
                                                minute
                  </p>
                  <div class="flex flex-col gap-1">
                    <label class="input input-border flex max-w-none items-center gap-2">
                      <svg class="h-4 w-4 opacity-70"
                           fill="currentColor"
                           viewBox="0 0 16 16"
                           xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <div class="flex flex-col gap-4">
                  ...
                  <div class="stat">
                    <div class="stat-figure">
                      <div class="radial-progress"
                           role="progressbar"
                           style="--value:91;--size:3rem;">91
                      </div>
                    </div>
                    <div class="stat-title">Page Score</div>
                    <div class="stat-value">91
                      <span class="text-sm">/100</span>
                    </div>
                    <div class="stat-desc flex items-center gap-1">
                      <svg class="text-success size-4"
                           fill="currentColor"
                           viewBox="0 0 16 16"
                           xmlns="http://www.w3.org/2000/svg">
                        <path clip-rule="evenodd"
              ...
              <div class="card bg-base-100 card-border border-base-300 card-sm">
                <div class="card-body gap-4">
                  <h2 class="flex items-center justify-between"><span class="flex items-center gap-2 font-semibold"><svg
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"></path></svg> Recent orders</span>
                  </h2>
              ...
              <div class="card bg-base-100 card-border border-base-300">
                <ul class="menu w-full">
                  ...
                  <li><span><svg class="size-5 opacity-30"
                                 fill="none"
                                 stroke="currentColor"
                                 stroke-width="1.5"
                                 viewBox="0 0 24 24"
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"></path></svg> Databases <span
                      class="badge justify-self-end">7</span></span>
                  </li>
                  <li><span><svg class="size-5 opacity-30"
                                 fill="none"
                                 stroke="currentColor"
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"></path></svg> Products</span>
                  </li>
                  <li><span><svg class="size-5 opacity-30"
                                 fill="none"
                                 stroke="currentColor"
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"></path></svg> Messages <span
                      class="badge justify-self-end">29</span></span>
                  </li>
                  <li><span><svg class="size-5 opacity-30"
                                 fill="none"
                                 stroke="currentColor"
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"></path></svg> Access tokens</span>
                  </li>
                  <li><span><svg class="size-5 opacity-30"
                                 fill="none"
                                 stroke="currentColor"
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"></path></svg> Users <span
                      class="status status-info"></span></span>
                  </li>
                  <li><span><svg class="size-5 opacity-30"
                                 fill="none"
                                 stroke="currentColor"
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"></path></svg> Settings</span>
                  </li>
                </ul>
              </div>
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="border-base-300 flex flex-col border-t px-6 py-4">
                  <div class="relative mt-6">
                    <div class="tooltip tooltip-open absolute top-2 before:text-xs"
                         data-tip="13:39"
                         style="inset-inline-start:10%"></div>
                ...
                <div class="flex items-center justify-around px-2 pb-6">
                  ...
                  <button class="btn btn-square">
                    <svg fill="none"
                         ...
                         width="16"
                         xmlns="http://www.w3.org/2000/svg">
                      <path d="M40 33L44 37L40 41"
                            stroke="currentColor"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                            stroke-width="4"></path>
                      <path d="M40 7L44 11L40 15"
                            stroke="currentColor"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                            stroke-width="4"></path>
                  ...
                  <button class="btn btn-square">
                    <svg fill="none"
                         ...
                         width="16"
                         xmlns="http://www.w3.org/2000/svg">
                      <path d="M4 25C4 18.3502 9.39624 13 16 13H44"
                            stroke="currentColor"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                            stroke-width="4"></path>
                      <path d="M38 7L44 13L38 19"
                            ...
                            stroke-linejoin="round"
                            stroke-width="4"></path>
                      <path d="M44 23C44 29.6498 38.6038 35 32 35H4"
                            stroke="currentColor"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                            stroke-width="4"></path>
                      <path d="M10 41L4 35L10 29"
                            stroke="currentColor"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                            stroke-width="4"></path>
              ...
              <div class="mockup-code">
                <pre class="text-sm"
                     data-prefix="$"><code>npm i daisyui</code></pre>
                <pre class="text-sm"
                     data-prefix=">"><code>installing...</code></pre>
                <pre class="text-sm"
                     data-prefix=">"><code>Done!</code></pre>
              </div>
              <div class="flex flex-col gap-4">
