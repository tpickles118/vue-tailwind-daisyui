...
const buttonComponentBlocks = new ButtonModel(
  "component-blocks",
  "previewtabs",
  "Component Blocks",
  Constants.SVG_ICONS_HTML.COMPONENT_BLOCKS,
  Constants.inputTypes.RADIO
);

const buttonKeyValueList = new ButtonModel(
  "component-variants",
  "previewtabs",
  "Component Variants",
  Constants.SVG_ICONS_HTML.KEY_VALUE_LIST,
  Constants.inputTypes.RADIO
);

const buttonColorPalette = new ButtonModel(
  "color-palette",
  "previewtabs",
  "Color Palette",
  Constants.SVG_ICONS_HTML.COLOR_PALETTE,
  Constants.inputTypes.RADIO
);
...
<template>
  <div :data-theme="currentTheme">
    <RowBufferedSlotted class="space-x-2 justify-start py-2">
      <button class="btn btn-neutral" @click="handleToggleThemeClick">
        Swap Theme
      </button>
    ...
    <div class="max-md:hidden">
      <div
        class="text-base-content pt-6 transition-colors duration-500 bg-base-200"
      >
        <RowBufferedSlotted>
          <h2 class="font-title text-lg md:max-lg:hidden">Components Demo</h2>
          <TabsContainerSmSlotted>
            <LabeledInputSlotted
              :button-model="buttonComponentBlocks"
              @button-clicked="callback"
            >
              <InjectectableHtmlSvg
                :svg-html-data="buttonComponentBlocks.svgHtmlData"
              />
            </LabeledInputSlotted>
            <LabeledInputSlotted
              :button-model="buttonKeyValueList"
              @button-clicked="callback"
            >
              <InjectectableHtmlSvg
                :svg-html-data="buttonKeyValueList.svgHtmlData"
              />
            </LabeledInputSlotted>
            <LabeledInputSlotted
              :button-model="buttonColorPalette"
              @button-clicked="callback"
            >
              <InjectectableHtmlSvg
                :svg-html-data="buttonColorPalette.svgHtmlData"
              />
            </LabeledInputSlotted>
            <!--
          ...
          >
            <div class="flex flex-col gap-4">
              ...
              <CardSlotted>
                <div class="card-body gap-4">
                  <div
                    class="border-b-base-300 grid grid-cols-7 border-b border-dashed pb-3"
                  >
                    <div
                      class="rounded-field flex flex-col items-center px-2 py-1"
                    >
                  ...
                  <div>
                    <label
                      class="input input-sm input-border flex w-auto items-center gap-2"
                    >
                      <svg
                        class="size-4"
                        fill="currentColor"
              ...
              <div
                class="card bg-base-100 card-border border-base-300 card-sm overflow-hidden"
              >
                <div class="card-body gap-4">
                  <div
                    class="border-b-base-300 grid grid-cols-7 border-b border-dashed pb-3"
              ...
              <div class="card bg-base-100 card-border border-base-300 card-sm">
                <div class="card-body gap-4">
                  ...
                  <input class="range range-sm" type="range" />
                </div>
              </div>
              <div class="card bg-base-100 card-border border-base-300 card-sm">
                <figure class="p-2">
              ...
              <div class="card bg-base-100 card-border border-base-300 card-sm">
                <div class="card-body gap-4">
                  <div class="join">
                    <label
                      class="join-item input-border input flex w-auto items-center gap-2"
                    >
                      <svg
                ...
                <div class="card-body gap-4">
                  ...
                  <div class="flex flex-col gap-1">
                    ...
                    >
                      ...
                      <input class="grow" placeholder="Username" type="text" />
                    </label>
                  </div>
                  <div class="flex flex-col gap-1">
                    <label
                    ...
                    <span
                      class="text-base-content/60 flex items-center gap-2 px-1 text-[0.6875rem]"
                  ...
                  >
                    <input class="toggle toggle-xs" type="checkbox" />
            ...
            <div class="flex flex-col gap-4">
              <div class="card bg-base-100 card-border border-base-300 card-sm">
                <div class="card-body gap-4">
                  <div
                    class="*:bg-base-content mt-4 flex h-24 items-end gap-2 *:w-full *:rounded-sm"
                  >
                  ...
                  <p class="py-3 text-xs">
                    Sales volume reached $12,450 this week, showing a 15%
              ...
              >
                ...
                <div class="card-body gap-4">
                  ...
                  ></textarea>
                  <p class="px-2 text-xs opacity-40">
                ...
                <ul class="menu w-full">
                  ...
                  <li>
                    <span
                      ...
                      Databases
                      <span class="badge justify-self-end">7</span></span
                    >
                  </li>
                  <li>
                    <span
                  ...
                  <li>
                    <span
                      ...
                      Messages
                      <span class="badge justify-self-end">29</span></span
                    >
                  </li>
                  <li>
                    <span
                  ...
                  <li>
                    <span
                      ...
                      Users <span class="status status-info"></span
                    ></span>
                  </li>
                  <li>
                    <span
            ...
            <div class="flex flex-col gap-4">
              ...
              <div class="flex flex-col gap-4">
                <div
                  class="alert max-sm:alert-vertical alert-info text-xs font-bold"
                >
                  <svg
                    class="size-6"
                    fill="none"
                ...
                <div
                  class="alert alert-outline max-sm:alert-vertical alert-success text-xs font-bold"
                >
                  <svg
                    class="size-6"
                    fill="none"
                ...
                <div
                  class="alert alert-dash max-sm:alert-vertical alert-warning text-xs font-bold"
                >
                  <svg
                    class="size-6"
                    fill="none"
                  ...
                  <span
                    ><span class="link">Click</span> to verify your email</span
                  >
                </div>
                <div
                  class="alert alert-soft max-sm:alert-vertical alert-error text-xs font-bold"
                >
                  <svg
                    class="size-6"
                    fill="none"
              ...
              >
                <div class="flex justify-center">
                  <div
                    class="tabs tabs-box bg-base-300 m-4 inline-flex flex-nowrap"
                  >
                    <input
                      aria-label="Monthly"
                      class="tab w-1/2"
                    ...
                    <div class="indicator w-1/2">
                      <div class="indicator-item badge badge-warning badge-xs">
                        SALE
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-body gap-4">
                  <div class="flex flex-col">
                    <h4 class="font-bold tracking-wide opacity-50">
                      Starter Plan
                    </h4>
                    <div>
                      <span class="text-4xl font-black">$200</span>
                      <span class="opacity-50">/month</span>
                    </div>
                  </div>
                  <div class="my-2 flex flex-col text-xs">
                    <div
                      class="border-b-accent/5 flex items-center gap-2 border-b pb-2"
                    >
                      <svg
                        class="text-success size-4"
                        fill="currentColor"
